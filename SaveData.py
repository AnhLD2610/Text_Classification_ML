...
pickle.dump(X_train, open('D:\ML_project\FinalData\X_train_w2v.pkl', 'wb'))
pickle.dump(y_train, open('D:\ML_project\FinalData\X_test_w2v.pkl', 'wb'))
pickle.dump(X_test, open('D:\ML_project\FinalData\y_train_w2v.pkl', 'wb'))
pickle.dump(y_test, open('D:\ML_project\FinalData\y_test_w2v.pkl', 'wb'))
